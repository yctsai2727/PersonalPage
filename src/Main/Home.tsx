...
export default function Home () {
    ...
    return (
        <Card  variant="outlined" sx={{width:"75%", padding:"8px", borderRadius:"16px", mb:"30px",boxShadow:"2px 5px rgba(0,0,0,0.05)","marginLeft":"auto","marginRight":"auto"}}>
            <CardHeader        
            title="About Me"
                    />
        <CardContent>
        <Typography variant="body2" color="text.secondary" display="inline" align="left" sx={{"flexWrap":"wrap"}}>
